...
void Settings::Draw()
{
    if (cOpen)
    {
        ...
        // Abas sem imagens - apenas texto
        if (Tab == 0)
            dsTextLineOut(WinX + 80, WinY + 58, " ", 5);
        else
            dsTextLineOut(WinX + 80, WinY + 58, " ", 5);

        if (Tab == 1)
            dsTextLineOut(WinX + 205, WinY + 58, " ", 5);
        else
            dsTextLineOut(WinX + 205, WinY + 58, " ", 5);

        if (Tab == 2)
            dsTextLineOut(WinX + 320, WinY + 58, " ", 5);
        else
            dsTextLineOut(WinX + 320, WinY + 58, " ", 5);

        // Botão de fechar em texto
        if (MouseAction(WinX + 513, WinY + 7, 33, 48))
            dsTextLineOut(WinX + 518, WinY + 20, " ", 1);
        else
            dsTextLineOut(WinX + 518, WinY + 20, " ", 1);
        ...
        if (Tab == 0)
        {
            ...
            // Removido completamente o seletor de Tela Cheia, apenas texto
            dsTextLineOut(WinX + 50, WinY + 110, "F12 para mudar", 14);
        ...
        else if (Tab == 2)
        {
            ...
            dsTextLineOut(WinX + 365, WinY + 218, "Filtro de Cor", 27);
...
void Settings::Button()
{
    if (cOpen)
    {
        ...
        if (Tab == 0)
        {
            // Removido o MouseAction para o seletor de Tela Cheia (posição WinX + 50, WinY + 107)
...
void Settings::Load()
{
    ...
    if (bRatio == 0)
    {
        ...
        else if (smConfig.ScreenSize.x == 1024 && smConfig.ScreenSize.y == 768)
        {
            bResolution = 1;
            cResolution = 1;
        }
        else if (smConfig.ScreenSize.x == 1280 && smConfig.ScreenSize.y == 960)
        {
            bResolution = 2;
            cResolution = 2;
        }
        else if (smConfig.ScreenSize.x == 1400 && smConfig.ScreenSize.y == 1050)
        {
            bResolution = 3;
            cResolution = 3;
        }
    ...
    {
        if (smConfig.ScreenSize.x == 1280 && smConfig.ScreenSize.y == 1024)
        {
            bResolution = 4;
            cResolution = 4;
        }
    ...
    {
        if (smConfig.ScreenSize.x == 1280 && smConfig.ScreenSize.y == 720)
        {
            bResolution = 5;
            cResolution = 5;
        }
        else if (smConfig.ScreenSize.x == 1366 && smConfig.ScreenSize.y == 768)
        {
            bResolution = 6;
            cResolution = 6;
        }
        else if (smConfig.ScreenSize.x == 1600 && smConfig.ScreenSize.y == 900)
        {
            bResolution = 7;
            cResolution = 7;
        }
        else if (smConfig.ScreenSize.x == 1920 && smConfig.ScreenSize.y == 1080)
        {
            bResolution = 8;
            cResolution = 8;
        }
    ...
    {
        if (smConfig.ScreenSize.x == 1280 && smConfig.ScreenSize.y == 800)
        {
            bResolution = 9;
            cResolution = 9;
        }
        else if (smConfig.ScreenSize.x == 1440 && smConfig.ScreenSize.y == 900)
        {
            bResolution = 10;
            cResolution = 10;
        }
        else if (smConfig.ScreenSize.x == 1680 && smConfig.ScreenSize.y == 1050)
        {
            bResolution = 11;
            cResolution = 11;
        }
        else if (smConfig.ScreenSize.x == 1920 && smConfig.ScreenSize.y == 1200)
        {
            bResolution = 12;
            cResolution = 12;
        }
